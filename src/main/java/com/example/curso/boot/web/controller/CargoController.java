...
public class CargoController {
	...
	@PostMapping("/salvar")
	public String salvar(@Valid Cargo cargo, RedirectAttributes attr, BindingResult result) {
	...
	public String preEditar(@PathVariable("id") Long id, ModelMap model) {
		...
		return "cargo/cadastro"; //cadatro.html
	}
	
	@PostMapping("/editar")
	public String editar(@Valid Cargo cargo, RedirectAttributes attr, BindingResult result) {
